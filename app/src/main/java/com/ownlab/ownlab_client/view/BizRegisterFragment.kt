...
import com.ownlab.ownlab_client.databinding.FragmentBizRegisterBinding
...
@AndroidEntryPoint
class BizRegisterFragment : Fragment() {
    private var _binding: FragmentBizRegisterBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBizRegisterBinding.inflate(inflater, container, false)
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.idChkBtn.setOnClickListener {
            registerViewModel.idChk(Id(binding.idField.text.toString()), object:
        ...
        binding.registerBtn.setOnClickListener {
            ...
            val name: String = binding.companyName.text.toString()
            val tel: String = binding.ceoTel.text.toString()
            ...
            if (password != _password) {
                ...
                registerViewModel.registerCompany(Info(id, password, name, tel), object:
                    CoroutinesErrorHandler {
                    override fun onError(m : String) {
                        try {
                            val action =
